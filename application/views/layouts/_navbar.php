<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<div class="container">
		<a class="navbar-brand" href="<?= base_url('home') ?>">
			<img src="<?= base_url() ?>/images/logo/dobaka.png" width="170" height="57" class="d-inline-block align-top" alt="logo" loading="lazy">
		</a>
			...
			<div class="navbar-nav ml-auto">
				<?php if($this->session->login == TRUE) : ?>
					...
					<?php if($this->session->userdata('role') == 2) : ?>
						...
						<a class="nav-item nav-link mr-4 active" href="<?= base_url('items/add') ?>">
