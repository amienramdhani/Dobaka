		...
		<?php foreach($banners as $b) : ?>
			...
			<div class="carousel-item <?php if($no <= 1) { echo "active"; } ?>">
				...
				<div class="carousel-caption d-none d-md-block  <?= $b['text_color'] ?>">
					...
					<a href="<?= base_url('home/detail/' . $b['product_id']) ?>" class="btn btn-success badge-pill mt-3" style="width:200px">DONATE NOW</a>
				</div>
			</div>
		<?php endforeach ?> 
	</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mt-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="https://api.whatsapp.com/send?phone=<?= $game['no_hp'] ?>"><i class="fa-brands fa-whatsapp-square">WhatsApp</i></a>
