<div class="container">
	<div class="row mt-4">
		<div class="col">
			<h2 class="text-center">Add New Items</h2>
		</div>
	</div>
	...
	<div class="row bg-light p-3 mt-4">
		<div class="col">
			...
			<?= form_open_multipart(base_url('items/add')) ?>
				<div class="form-group row">
					<label for="name" class="col-sm-2 col-form-label font-weight-bold">Items Name</label>
					<div class="col-sm-10">
				...
				<div class="row">
					...
					<div class="col-5">
						<div class="form-group">
							<label class="font-weight-bold">No Handphone/Whatsapp</label>
